...
const sendEmail = (email, subject, data) => {
  try { 
    const transporter = nodemailer.createTransport({
      ...
      // host: process.env.EMAIL_HOST, // IONOS SMTP server
      // port: process.env.EMAIL_PORT, // SMTP port (usually 587 for STARTTLS)
      // secure: true, // True for 465, false for other ports (STARTTLS)
      // auth: {
      //   user: process.env.ADMIN_USER, // Your IONOS email address
      //   pass: process.env.ADMIN_PASSWORD  // Your IONOS email password
       },
      tls: {
